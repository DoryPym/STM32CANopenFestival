...
uint8_t DLL_CALL(canReceive)(CAN_HANDLE, Message *)FCT_PTR_INIT;
uint8_t DLL_CALL(canSend)(CAN_HANDLE, Message const *)FCT_PTR_INIT;
CAN_HANDLE DLL_CALL(canOpen)(s_BOARD *)FCT_PTR_INIT;
int DLL_CALL(canClose)(CAN_HANDLE)FCT_PTR_INIT;
//uint8_t DLL_CALL(canChangeBaudRate)(CAN_HANDLE, char *)FCT_PTR_INIT; //zxb change this
