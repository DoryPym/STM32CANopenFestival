...
typedef void (*heartbeatError_t)(CO_Data*, uint8_t);
void _heartbeatError(CO_Data* d, uint8_t heartbeatID);

typedef void (*post_SlaveBootup_t)(CO_Data*, uint8_t);
void _post_SlaveBootup(CO_Data* d, uint8_t SlaveID);

typedef void (*post_SlaveStateChange_t)(CO_Data*, uint8_t, e_nodeState);
